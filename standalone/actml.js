...
var process = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(branch) {
    ...
    var callChildren = function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(additionalProps) {
        var childrenResult, children, i, funcResult;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 14:
                ...
                _context.next = 17;
                return children[i](additionalProps);
      ...
      return function callChildren(_x3) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            hooksProps = initializeHooks(branch, callChildren, stack);
            _context2.next = 4;
