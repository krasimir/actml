...
var _defineChildrenProp = require('../processor/defineChildrenProp');
...
function Element(func, props, children) {
  ...
  var element = {
    ...
    run: function run(parent, done) {
      ...
      return (0, _processor2.default)(this, done);
    }
  };

  element.props = _extends({
    children: (0, _defineChildrenProp2.default)(element)
  }, props);
